...
export function ThemeToggle({ className }: ThemeToggleProps) {
  ...
  return (
    <button
      ...
      className={cn(
        'inline-flex items-center gap-3 rounded-full border border-border/80 bg-card/75 px-3 py-2.5 text-sm font-semibold text-foreground transition hover:-translate-y-0.5 hover:border-primary/45 hover:text-primary',
        className,
      )}
    >
