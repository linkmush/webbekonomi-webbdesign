    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          className={cn(
            'inline-flex h-13 max-w-full min-w-0 items-center justify-between gap-3 rounded-full border border-border/80 bg-card/75 px-3 py-2.5 text-sm font-semibold text-foreground transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/45 hover:text-primary focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/12 data-[state=open]:border-primary/45 data-[state=open]:bg-card data-[state=open]:text-primary sm:min-w-36',
            className,
          )}
        >
      ...
      <DropdownMenuContent align={align} className="max-w-[calc(100vw-1rem)] min-w-[10rem] sm:min-w-42">
        <DropdownMenuRadioGroup
