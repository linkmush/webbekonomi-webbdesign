    ...
    <section className="relative overflow-hidden pt-16 sm:pt-20 lg:pt-24">
      <Container>
        <motion.div
          ...
          animate="visible"
          viewport={viewport}
          className="surface-panel relative overflow-hidden px-6 py-10 sm:px-8 sm:py-12 lg:px-10"
        >
          ...
          <div className="relative max-w-3xl">
            ...
            <h1 className="mt-5 text-4xl leading-tight sm:text-5xl lg:text-[3.5rem]">
              {title}
            </h1>
            ...
            {chips.length > 0 ? (
              <div className="mt-6 flex flex-wrap gap-3">
                {chips.map((chip) => (
                  <span
                    key={chip}
                    className="rounded-full border border-border/80 bg-background/65 px-4 py-2 text-sm font-medium text-foreground/90"
                  >
                    {chip}
                  </span>
                ))}
