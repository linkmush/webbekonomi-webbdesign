      ...
      <div className="grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        ...
        >
          {valuePillars.map(({ description, icon: Icon, id, title }) => (
            <motion.div key={id} variants={fadeUp} className="surface-panel flex gap-4 p-5 sm:p-6">
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={viewport}
          className="surface-panel overflow-hidden p-5 sm:p-8"
        >
          ...
          <div className="mt-5 grid gap-4">
            {serviceCards.slice(0, 3).map((service) => (
              ...
              >
                <h3 className="text-[1.35rem] leading-tight sm:text-2xl">{service.title}</h3>
